package com.example.myfiles.websocket;
...
@Component
public class WebSocketServer_login {
    ...
    private static CopyOnWriteArraySet<WebSocketServer_login> webSocketSet = new CopyOnWriteArraySet<WebSocketServer_login>();

    public static CopyOnWriteArraySet<WebSocketServer_login> getWebSocketSet() {
        return webSocketSet;
    }
...
//与某个客户端的连接会话，需要通过它来给客户端发送数据
    ...
    public void letHeLoginOut(String userid){
        for (WebSocketServer_login item : webSocketSet) {
...
//        System.out.println(message);
    ...
    public static void sendOneLoginedMen(String userid,String message){
        for (WebSocketServer_login item : webSocketSet) {
            if(item.userid.equals(userid)) {
                try {
                    item.sendMessage(message);
    ...
    public static synchronized void addOnlineCount() {
        ...
        WebSocketServer_login.onlineCount++;
